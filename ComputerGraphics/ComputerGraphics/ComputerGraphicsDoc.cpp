...
// ComputerGraphicsDoc.cpp : CComputerGraphicsDoc 类的实现
//
...
// 缩略图的支持
void CComputerGraphicsDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CComputerGraphicsDoc::InitializeSearchContent()
{
...
void CComputerGraphicsDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
